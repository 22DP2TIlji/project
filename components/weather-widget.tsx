  ...
  useEffect(() => {
    const fetchWeather = async () => {
      ...
      try {
        ...
        // ✅ 2. formāts: lapas līmeņa (OpenWeather tipa) { current, forecast }
        if (data?.current?.main?.temp != null) {
          const w: WidgetWeather = {
            ...
            // Pārvēršam m/s uz km/h, ja nepieciešams:
  ...
  if (loading) {
    return (
      <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
        <p className="text-gray-600">Ielādē laikapstākļus...</p>
      </div>
    )
  }
    ...
    <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-md p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm text-gray-600">Temperatūra</p>
        ...
        {weather.humidity !== null && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-gray-600">Mitrums</p>
        ...
        {weather.windSpeed !== null && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-gray-600">Vējš</p>
        ...
        {weather.precipitation !== null && weather.precipitation > 0 && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-gray-600">Nokrišņi</p>
